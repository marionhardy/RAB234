---
title: "RAB234_Trp_KO_RNAseq_report"
author: "Marion Hardy"
date: "2023-06-21"
output: 
  html_document:
...
res_tbl <- read_csv("./data_output/Mrpl_Trpn_vs_Trpp/res_tbl.csv")
diff <- read_csv("./data_output/Mrpl_Trpn_vs_Trpp/res_tbl_signif.csv")
...
res_tbl %>%
  ...
  geom_vline(xintercept = 1) +
  geom_vline(xintercept = -1)+
  labs(title = "Mrpl28KO Trp- vs Trp+")+
  theme_bw()+

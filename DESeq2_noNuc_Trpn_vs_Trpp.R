...
write.csv(res_tbl,"./data_output/Nonuc_Trpn_vs_Trpp/res_tbl.csv", row.names = T)
...
write.xlsx(list_of_datasets, file = "./data_output/Nonuc_Trpn_vs_Trpp/RAB234_sign_genes.xlsx")
...
ggsave("./figures/Nonuc_Trpn_vs_Trpp/volcanoplot.png", last_plot(), device = png, dpi= 500, width = 8, height = 6)

saveRDS(dds, file = "./data_output/Nonuc_Trpn_vs_Trpp/dds.rds")
saveRDS(res_tbl, file = "./data_output/Nonuc_Trpn_vs_Trpp/res_tbl.rds")
write_csv(res_tbl, file = "./data_output/Nonuc_Trpn_vs_Trpp/res_tbl.csv")
res_tbl1 <-  res_tbl %>% filter(!is.na(ENTREZID), padj<0.05)
saveRDS(res_tbl1, file = "./data_output/Nonuc_Trpn_vs_Trpp/res_tbl_signif.rds")
write_csv(res_tbl1, file = "./data_output/Nonuc_Trpn_vs_Trpp/res_tbl_signif.csv")

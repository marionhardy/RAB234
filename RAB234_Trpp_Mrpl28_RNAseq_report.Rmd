---
title: "RAB234_Trpp_Mrpl28_RNAseq_report"
author: "Marion Hardy"
date: "2023-06-15"
output: 
  html_document:
...
res_tbl <- read_csv("./data_output/Trpp_Mrpl_vs_Scr/res_tbl.csv")
diff <- read_csv("./data_output/Trpp_Mrpl_vs_Scr/res_tbl_signif.csv")
...
res_tbl %>%
  ...
  geom_vline(xintercept = 1) +
  geom_vline(xintercept = -1)+
  labs(title = "Mrpl28 KO vs Scramble in Trp+")+
  theme_bw()+
...
library(fgsea)
plotEnrichment(gsea_results_gl[["GOBP_OXIDATIVE_PHOSPHORYLATION"]],
...
Highlight on the volcano plot of the genes found to be implicated in glycolysis + table
...
res_tbl %>%
  ...
  geom_vline(xintercept = 1) +
  geom_vline(xintercept = -1)+
  labs(title = "Mrpl28 KO vs Scramble in Trpp")+
  theme_bw()+
  geom_point(data=target, 
             aes(x=log2FoldChange,y=-log10(padj)), 
             color='blue',
...
res_tbl %>%
  ...
  geom_vline(xintercept = 1) +
  geom_vline(xintercept = -1)+
  labs(title = "Mrpl28 vs scramble in Trp+")+
  theme_bw()+
  geom_point(data=target, 
             aes(x=log2FoldChange,y=-log10(padj)), 
             color='blue',
